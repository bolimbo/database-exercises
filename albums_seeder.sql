...
VALUES ('Michael Jackson', 'Thriller', 1982, 4.7, 'Pop, Rock, R&B'),
  ...
  ('Eagles', 'Their Greatest Hits', 1976, 20.6, 'Rock, Soft rock, Folk rock'),
  ...
  ('Meat Loaf', 'Bat Out of Hell', 1977, 2.25, 'Hard rock, Progressive rock'),
